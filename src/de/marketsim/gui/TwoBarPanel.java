 ...
 *   Daten: Vector von  ( 2 DoubleWerte, 1 String Beschreibung  )
...
public class TwoBarPanel extends JPanel
{
  ...
  private void drawCoordination(Graphics g)
  {
      ...
      drawplatte.drawString("Agent",
        ...
        drawplatte.drawString("Blue : + Profit, Red : -Profit",this.mCoordinator.x0+ 5, this.mCoordinator.y0 + 74    );
  ...
  private void drawTwoBar(Graphics g)
  {
        ...
        {
           TwoBarBaseData dd = (TwoBarBaseData)this.mGewinnData.elementAt(m);
           xx2 = (int) ( this.mCoordinator.x0 + (m+1) * OneXScaleLength )  ;
           xx3 = xx2 - ( int ) ( OneXScaleLength / 2 );

           yy2 = this.mCoordinator.y0 -
                 (int) ( ( Math.abs ( dd.mAbsoluteGewinnProzent ) - kdoublemin ) * (this.mCoordinator.y0-this.mCoordinator.ymax) / (kdoublemax-kdoublemin)  );

           yy3 = this.mCoordinator.y0 -
           ...
           if ( dd.mAbsoluteGewinnProzent >=0.0 )
           {
               // Fill-Color: Blue
           ...
           drawplatte.fillRect( xx1, yy2,  ( int ) ( OneXScaleLength / 2 ), ( this.mCoordinator.y0 -  yy2 ));
           ...
           */
           ...
           drawplatte.fillRect( xx3, yy3,  ( int ) ( OneXScaleLength / 2 ) - 1, ( this.mCoordinator.y0 - yy3));
           ...
           */
           ...
           drawplatte.drawString( dd.mData2Description, xx1+2, this.mCoordinator.y0 + 39 );
           xx1 = xx2;
        }
  }
  ...
  private void UpdateY_Achse_Scale()
  {
        ...
        {
           TwoBarBaseData pp = (TwoBarBaseData) this.mGewinnData.elementAt(i);
           kdoublemax = Math.max( kdoublemax, Math.abs( pp.mAbsoluteGewinnProzent ) );
        }
  }
