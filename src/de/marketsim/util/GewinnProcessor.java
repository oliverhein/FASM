...
public class GewinnProcessor
{
  ...
  */
  ...
  {
       mGewinnProcessor.mDepotList.clear();
  }
  ...
  public static void PrintOneDepotRecord_TextFormat ( int pNr, DepotRecord pDepot, java.io.PrintStream fw, DataFormatter ffm, String pSeperator )
  {
       fw.print( pNr + pSeperator);
       fw.print( pDepot.mAgentName +pSeperator);
       fw.print( pDepot.mAgentInitTypeName +pSeperator );
       fw.print( ffm.format2str(  pDepot.mAbsoluteGewinnProzent ) + pSeperator );
       fw.print( pDepot.mInitDepot +pSeperator );
       fw.print( pDepot.mCurrentDepot +pSeperator ) ; // CurrentDepot is auch EndDepot
       ...
       fw.print( pDepot.mInitPrice + pSeperator );
       fw.print( pDepot.mInitAktienMenge + pSeperator );
       fw.print( pDepot.mInitCash + pSeperator );

       fw.print( pDepot.mCurrentPrice + pSeperator );
       fw.print( pDepot.mCurrentAktienMenge + pSeperator );
       fw.print( pDepot.mCurrentCash + pSeperator );
  ...
  public static void PrintDepotRecord_Summe_TextFormat ( String pSumText, DepotRecord pDepot, java.io.PrintStream fw, DataFormatter ffm, String pSeperator )
  {
  ...
  public static void PrintOneDepotRecord_HTMLFormat ( int pNr, DepotRecord pDepot, java.io.PrintStream fw, DataFormatter ffm )
  {
       ...
       fw.print( "<TD>" + ffm.format2str( pDepot.mAbsoluteGewinnProzent ) +"</TD>" );
  ...
  public static void PrintOneDepotRecordSumme_HTMLFormat ( DepotRecord pDepot, java.io.PrintStream fw, DataFormatter ffm, int pAgentAnzahl )
  {
       ...
       fw.print( "<TD></TD>" );
       fw.print( "<TD>" + ffm.format2str(  pDepot.mAbsoluteGewinnProzent/pAgentAnzahl ) +"</TD>" );
       fw.print( "<TD>" + pDepot.AktienMarket_getInitDepot() +"</TD>" );
       fw.print( "<TD>" + pDepot.AktienMarket_getCurrentDepot() +"</TD>" ) ; // CurrentDepot is auch EndDepot
       fw.print( "<TD>" + pDepot.mTotalBuyStuck +"</TD>");
       fw.print( "<TD>" + pDepot.mTotalSellStuck +"</TD>" );
  ...
  public static void createDepotStatistic_TextFile(String pDepotListTextFile )
  {
    ...
    fw.print( "InitDepot;EndDepot;BuySumme;SellSumme;TypChangesCounter;DetailedAbwicklung;");
  ...
  public static void createDepotStatistic_HTMLFile( String  pDepotListHTMLFileName   )
  {
    ...
    fw.println( "<Font color='blue' Size='16'>Group Statistic Comparation </Font> <Br> " );
  ...
  public static void PrintGroupStatistic( java.io.PrintStream fw, AgentGroupStatisticBasicWert  pStatistic, String pGroupName, String pGroupType, DataFormatter ffm )
  {

    fw.println("<TR>");
    fw.println("<TD>" + pGroupName                                       + "</TD>");
    fw.println("<TD>" + ffm.format2str( pStatistic.mAgentAnzahl ) + "</TD>");
    ...
    fw.println("<TD>" + ffm.format2str( pStatistic.mTypeChangeCounter )             + "</TD>");

    fw.println("<TD>" + ffm.format2str ( pStatistic.mAbsoluteGewinnProcent_Max ) + "</TD>");
    fw.println("<TD>" );
    ...
    fw.println("<TD>" + ffm.format2str ( pStatistic.mAbsoluteGewinnProcent_Min ) + "</TH>");
    fw.println("<TD>" );
