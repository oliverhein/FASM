...
public class DataLoggerBehavior extends CyclicBehaviour
{
		                                              ...
		                                              DailyOrderStatistic pDailyOrderStatistic)
  {
     ...
     try
     {
         ...
         String ss1 = "";
         // Print 5 Highest BuyLimit and the coresponding BuyVolume - Nachfrage
         ...
         ss1 = ss1 + nff.format2str(  pDailyOrderStatistic.mHighestBuyMengeSumme )+";";

         // Print 5 Low SellLimit and the coresponding SellVolume- Angebot
         for ( int i=0; i<pDailyOrderStatistic.mLowestSellLimitNumber_Real; i++)
         {
            ...
            ss1 = ss1 + nff.format2str( pDailyOrderStatistic.mLowestSellMengeList[i] ) + ";";
         }
         ...
         ss1 = ss1 + nff.format2str(  pDailyOrderStatistic.mLowestSellMengeSumme )+";";
